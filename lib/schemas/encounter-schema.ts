...
export const PLACEMENT_LOCATIONS = [
  ...
  'Detox',
  // Referral sources added as possible placements
  'Alpha project on 17th',
  'Alpha on 16th & Newton',
  'Neil good day center',
  'Rise Sober shelter (Father Joes\'s)',
  'Central Library (HUB)',
  'Dreams for Change (Safe Sleeping 0-lot)',
  'Dreams for Change (Safe Sleeping B-lot)',
  'Downtown Partnership (Safe Parking B-lot)',
  'Father Joe\'s',
  'VVSD',
  'Racheal Promise',
  'Racheal\'s day center',
  'Nami',
  'Inclement weather Activation',
  'Serving seniors',
  'Vista Outreach',
  'National city hot team',
  'Chula Vista hot team',
  'SCLH',
  'Jane Westin center (Behavioral Health center)',
  'Areta Crowell (Behavioral Heath center)',
  'PATH',
  '211',
  'DV hotline',
  'Your safe place (DV)',
