# Little Italy Street Reach

A comprehensive by-name list and service tracking system for San Diego Rescue Mission's street outreach program in Little Italy, San Diego.
...
```bash
git clone https://github.com/DSchacht0825/little-italy-street-reach.git
cd little-italy-street-reach
npm install
```
...
3. Run the migrations from `supabase/migrations/` in the SQL Editor (in order)
...
1. Check GitHub Issues: https://github.com/DSchacht0825/little-italy-street-reach/issues
